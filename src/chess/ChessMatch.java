...
public class ChessMatch {
	...
	// poderia iniciar a lista no próprio construtor, preferi aqui, pois garante-se
	// a iniciação desde a declaração da variável.
	...
	public ChessMatch() {
		...
		// check = false; opcional, o boolean começa com falso, colocar em caso de
		// necessidade de ênfase em um dos valores possíveis;
		initialSetup();
	}
